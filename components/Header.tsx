          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="hidden sm:block">
              {loading ? (
                ...
                <button onClick={login} className="bg-white text-brand-secondary font-bold py-2 px-4 rounded-lg text-sm transition-all duration-300 transform hover:scale-105 shadow flex items-center justify-center">
                    <GoogleIcon />
                    Masuk dengan Google
                </button>
              )}
                    ...
                    {loading ? <div className="p-4"><div className="h-8 bg-gray-200 rounded animate-pulse"></div></div> : (
                        user && profile ? (
                            ...
                            <div className="p-2 border-b border-gray-100">
                              <button onClick={() => { login(); setIsMobileMenuOpen(false); }} className="w-full bg-white border border-gray-300 hover:bg-gray-100 text-gray-800 font-bold py-2 px-4 rounded-md text-sm transition-all duration-300 flex items-center justify-center">
                                <GoogleIcon />
                                Masuk dengan Google
                              </button>
                            </div>
